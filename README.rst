...
**pyMassEvac** tests are included in the `tests directory <https://github.com/DRDC-RDDC/pyMassEvac/tree/main/tests>`_ directory and use the `pytest` testing framework.
